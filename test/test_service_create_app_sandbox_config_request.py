    ...
    def make_instance(self, include_optional) -> ServiceCreateAppSandboxConfigRequest:
        ...
        if include_optional:
            return ServiceCreateAppSandboxConfigRequest(
                connected_github_vcs_config = openapi_client.models.service/connected_github_vcs_sandbox_config_request.service.ConnectedGithubVCSSandboxConfigRequest(
                    branch = '', 
                    directory = '', 
                    git_ref = '', 
                    repo = '', ),
                public_git_vcs_config = openapi_client.models.service/public_git_vcs_sandbox_config_request.service.PublicGitVCSSandboxConfigRequest(
                    branch = '', 
                    directory = '', 
                    repo = '', ),
                sandbox_inputs = {
