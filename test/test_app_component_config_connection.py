    ...
    def make_instance(self, include_optional) -> AppComponentConfigConnection:
        ...
        if include_optional:
            return AppComponentConfigConnection(
                ...
                created_at = '',
                created_by_id = '',
                docker_build = openapi_client.models.app/docker_build_component_config.app.DockerBuildComponentConfig(
                    build_args = [
                        ''
                        ], 
                    ...
                    target = '', 
                    updated_at = '', ),
                external_image = openapi_client.models.app/external_image_component_config.app.ExternalImageComponentConfig(
                    aws_ecr_image_config = openapi_client.models.app/awsecr_image_config.app.AWSECRImageConfig(
                        aws_region = '', 
                        component_config_id = '', 
                        component_config_type = '', 
                        created_at = '', 
                    ...
                    tag = '', 
                    updated_at = '', ),
                helm = openapi_client.models.app/helm_component_config.app.HelmComponentConfig(
                    chart_name = '', 
                    component_config_connection_id = '', 
                    connected_github_vcs_config = openapi_client.models.app/connected_github_vcs_config.app.ConnectedGithubVCSConfig(
                        branch = '', 
                ...
                id = '',
                job = openapi_client.models.app/job_component_config.app.JobComponentConfig(
                    args = [
                        ''
                        ], 
                    cmd = [
                    ...
                    tag = '', 
                    updated_at = '', ),
                terraform_module = openapi_client.models.app/terraform_module_component_config.app.TerraformModuleComponentConfig(
                    component_config_connection_id = '', 
                    connected_github_vcs_config = openapi_client.models.app/connected_github_vcs_config.app.ConnectedGithubVCSConfig(
                        branch = '', 
                        component_config_id = '', 
