...
class TestAppAppBranch(unittest.TestCase):
    """AppAppBranch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppAppBranch:
        """Test AppAppBranch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppAppBranch`
        """
        model = AppAppBranch()
        if include_optional:
            return AppAppBranch(
                ...
                updated_at = '',
                workflows = [
                    nuon.models.app/workflow.app.Workflow(
