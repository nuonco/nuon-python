...
class TestAppRunnerHealthCheck(unittest.TestCase):
    """AppRunnerHealthCheck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppRunnerHealthCheck:
        """Test AppRunnerHealthCheck
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppRunnerHealthCheck`
        """
        model = AppRunnerHealthCheck()
        if include_optional:
            return AppRunnerHealthCheck(
                created_at = '',
                created_by_id = '',
                id = '',
                minute_bucket = '',
    ...
    def testAppRunnerHealthCheck(self):
        """Test AppRunnerHealthCheck"""
