...
class TestAppInstallActionWorkflowRun(unittest.TestCase):
    """AppInstallActionWorkflowRun unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppInstallActionWorkflowRun:
        """Test AppInstallActionWorkflowRun
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppInstallActionWorkflowRun`
        """
        model = AppInstallActionWorkflowRun()
        if include_optional:
            return AppInstallActionWorkflowRun(
                ...
                workflow = nuon.models.app/workflow.app.Workflow(
                    ...
                    step_error_behavior = 'abort', 
                    steps = [
                        nuon.models.app/workflow_step.app.WorkflowStep(
                            approval = null, 
                            created_at = '', 
                            created_by_id = '', 
                            execution_time = 56, 
    ...
    def testAppInstallActionWorkflowRun(self):
        """Test AppInstallActionWorkflowRun"""
