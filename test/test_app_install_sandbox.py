...
class TestAppInstallSandbox(unittest.TestCase):
    """AppInstallSandbox unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppInstallSandbox:
        """Test AppInstallSandbox
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppInstallSandbox`
        """
        model = AppInstallSandbox()
        if include_optional:
            return AppInstallSandbox(
                created_at = '',
                created_by_id = '',
                id = '',
                install_id = '',
    ...
    def testAppInstallSandbox(self):
        """Test AppInstallSandbox"""
