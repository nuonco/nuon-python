...
class TestAppActionWorkflowConfig(unittest.TestCase):
    """AppActionWorkflowConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppActionWorkflowConfig:
        """Test AppActionWorkflowConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppActionWorkflowConfig`
        """
        model = AppActionWorkflowConfig()
        if include_optional:
            return AppActionWorkflowConfig(
                action_workflow_id = '',
                app_config_id = '',
                app_id = '',
    ...
    def testAppActionWorkflowConfig(self):
        """Test AppActionWorkflowConfig"""
