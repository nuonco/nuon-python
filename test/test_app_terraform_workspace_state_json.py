...
class TestAppTerraformWorkspaceStateJSON(unittest.TestCase):
    """AppTerraformWorkspaceStateJSON unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppTerraformWorkspaceStateJSON:
        """Test AppTerraformWorkspaceStateJSON
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppTerraformWorkspaceStateJSON`
        """
        model = AppTerraformWorkspaceStateJSON()
        if include_optional:
            return AppTerraformWorkspaceStateJSON(
                contents = [
                    56
                    ],
                created_at = '',
    ...
    def testAppTerraformWorkspaceStateJSON(self):
        """Test AppTerraformWorkspaceStateJSON"""
