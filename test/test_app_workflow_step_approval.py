...
class TestAppWorkflowStepApproval(unittest.TestCase):
    """AppWorkflowStepApproval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppWorkflowStepApproval:
        """Test AppWorkflowStepApproval
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppWorkflowStepApproval`
        """
        model = AppWorkflowStepApproval()
        if include_optional:
            return AppWorkflowStepApproval(
                created_at = '',
                created_by_id = '',
                id = '',
                ...
                owner_id = '',
                owner_type = '',
                response = nuon.models.app/workflow_step_approval_response.app.WorkflowStepApprovalResponse(
                    created_at = '', 
                    created_by_id = '', 
                    id = '', 
    ...
    def testAppWorkflowStepApproval(self):
        """Test AppWorkflowStepApproval"""
