...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    service_create_org_user_request = openapi_client.ServiceCreateOrgUserRequest() # ServiceCreateOrgUserRequest | Input
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.OrgsApi(api_client)
    service_create_org_request = openapi_client.ServiceCreateOrgRequest() # ServiceCreateOrgRequest | Input
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.OrgsApi(api_client)
    service_update_org_request = openapi_client.ServiceUpdateOrgRequest() # ServiceUpdateOrgRequest | Input
