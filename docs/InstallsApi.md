...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    service_create_install_request = openapi_client.ServiceCreateInstallRequest() # ServiceCreateInstallRequest | Input
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    service_create_install_deploy_request = openapi_client.ServiceCreateInstallDeployRequest() # ServiceCreateInstallDeployRequest | Input
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.InstallsApi(api_client)
    install_id = 'install_id_example' # str | install ID
    service_create_install_inputs_request = openapi_client.ServiceCreateInstallInputsRequest() # ServiceCreateInstallInputsRequest | Input
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    service_installer_create_install_request = openapi_client.ServiceInstallerCreateInstallRequest() # ServiceInstallerCreateInstallRequest | Input
 ...
 **service_installer_create_install_request** | [**ServiceInstallerCreateInstallRequest**](ServiceInstallerCreateInstallRequest.md)| Input | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of InstallsApi->installer_get_install:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling InstallsApi->installer_get_install: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    service_update_install_request = openapi_client.ServiceUpdateInstallRequest() # ServiceUpdateInstallRequest | Input
