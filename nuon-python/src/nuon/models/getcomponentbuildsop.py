...
class GetComponentBuildsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetComponentBuildsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetComponentBuildsRequestTypedDict(TypedDict):
    component_id: NotRequired[str]
    r"""component id to filter by"""
    app_id: NotRequired[str]
    r"""app id to filter by"""
...
class GetComponentBuildsRequest(BaseModel):
