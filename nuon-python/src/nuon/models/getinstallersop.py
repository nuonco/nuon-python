...
class GetInstallersSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetInstallersSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetInstallersRequestTypedDict(TypedDict):
...
class GetInstallersRequest(BaseModel):
    offset: Annotated[
        Optional[int],
