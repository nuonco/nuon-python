...
class GetComponentReleasesSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetComponentReleasesSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetComponentReleasesRequestTypedDict(TypedDict):
    component_id: str
    r"""component ID"""
...
class GetComponentReleasesRequest(BaseModel):
