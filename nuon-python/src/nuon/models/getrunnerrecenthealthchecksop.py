...
class GetRunnerRecentHealthChecksSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetRunnerRecentHealthChecksSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetRunnerRecentHealthChecksRequestTypedDict(TypedDict):
    runner_id: str
    r"""runner ID"""
    window: NotRequired[str]
    r"""window of health checks to return"""
...
class GetRunnerRecentHealthChecksRequest(BaseModel):
    runner_id: Annotated[
