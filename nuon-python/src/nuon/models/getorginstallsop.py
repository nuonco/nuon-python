...
class GetOrgInstallsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetOrgInstallsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetOrgInstallsRequestTypedDict(TypedDict):
    offset: NotRequired[int]
    r"""offset of results to return"""
    q: NotRequired[str]
    r"""search query to filter installs by name"""
...
class GetOrgInstallsRequest(BaseModel):
    offset: Annotated[
        Optional[int],
