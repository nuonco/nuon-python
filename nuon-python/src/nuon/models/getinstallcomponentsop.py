...
class GetInstallComponentsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetInstallComponentsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetInstallComponentsRequestTypedDict(TypedDict):
    install_id: str
    r"""install ID"""
...
class GetInstallComponentsRequest(BaseModel):
