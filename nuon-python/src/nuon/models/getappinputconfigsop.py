...
class GetAppInputConfigsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetAppInputConfigsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetAppInputConfigsRequestTypedDict(TypedDict):
    app_id: str
    r"""app ID"""
...
class GetAppInputConfigsRequest(BaseModel):
    app_id: Annotated[
