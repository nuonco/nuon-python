...
class GetAppBranchesSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetAppBranchesSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetAppBranchesRequestTypedDict(TypedDict):
    app_id: str
    r"""app ID"""
...
class GetAppBranchesRequest(BaseModel):
    app_id: Annotated[
