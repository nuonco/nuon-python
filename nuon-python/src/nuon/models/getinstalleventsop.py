...
class GetInstallEventsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetInstallEventsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetInstallEventsRequestTypedDict(TypedDict):
    install_id: str
    r"""install ID"""
...
class GetInstallEventsRequest(BaseModel):
