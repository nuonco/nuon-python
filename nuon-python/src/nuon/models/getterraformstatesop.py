...
class GetTerraformStatesSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetTerraformStatesSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetTerraformStatesRequestTypedDict(TypedDict):
    workspace_id: str
    r"""workspace ID"""
...
class GetTerraformStatesRequest(BaseModel):
