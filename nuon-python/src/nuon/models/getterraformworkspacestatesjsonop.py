...
class GetTerraformWorkspaceStatesJSONSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetTerraformWorkspaceStatesJSONSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetTerraformWorkspaceStatesJSONRequestTypedDict(TypedDict):
    workspace_id: str
    r"""workspace ID"""
...
class GetTerraformWorkspaceStatesJSONRequest(BaseModel):
