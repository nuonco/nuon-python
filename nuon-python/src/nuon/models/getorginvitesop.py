...
class GetOrgInvitesSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetOrgInvitesSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetOrgInvitesRequestTypedDict(TypedDict):
...
class GetOrgInvitesRequest(BaseModel):
    offset: Annotated[
        Optional[int],
