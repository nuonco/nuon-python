...
class GetAppComponentsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetAppComponentsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetAppComponentsRequestTypedDict(TypedDict):
    app_id: str
    r"""app ID"""
    q: NotRequired[str]
    r"""search query to filter components by name"""
    types: NotRequired[str]
    r"""comma-separated list of component types to filter by (e.g., terraform_module, helm_chart)"""
...
class GetAppComponentsRequest(BaseModel):
    app_id: Annotated[
