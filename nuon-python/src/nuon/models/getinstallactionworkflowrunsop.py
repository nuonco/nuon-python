...
class GetInstallActionWorkflowRunsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetInstallActionWorkflowRunsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetInstallActionWorkflowRunsRequestTypedDict(TypedDict):
    install_id: str
    r"""install ID"""
...
class GetInstallActionWorkflowRunsRequest(BaseModel):
