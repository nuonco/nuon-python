...
class GetActionWorkflowsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetActionWorkflowsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetActionWorkflowsRequestTypedDict(TypedDict):
    app_id: str
    r"""app ID"""
    q: NotRequired[str]
    r"""search query to filter action workflows by name"""
...
class GetActionWorkflowsRequest(BaseModel):
    app_id: Annotated[
