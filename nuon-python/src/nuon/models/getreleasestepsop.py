...
class GetReleaseStepsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetReleaseStepsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetReleaseStepsRequestTypedDict(TypedDict):
    release_id: str
    r"""release ID"""
...
class GetReleaseStepsRequest(BaseModel):
