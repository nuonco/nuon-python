...
class GetInstallInputsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetInstallInputsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetInstallInputsRequestTypedDict(TypedDict):
    install_id: str
    r"""install ID"""
...
class GetInstallInputsRequest(BaseModel):
