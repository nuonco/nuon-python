...
class GetOrgAcountsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetOrgAcountsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetOrgAcountsRequestTypedDict(TypedDict):
...
class GetOrgAcountsRequest(BaseModel):
    offset: Annotated[
        Optional[int],
