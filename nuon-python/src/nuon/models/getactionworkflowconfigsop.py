...
class GetActionWorkflowConfigsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetActionWorkflowConfigsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetActionWorkflowConfigsRequestTypedDict(TypedDict):
...
class GetActionWorkflowConfigsRequest(BaseModel):
