...
class GetRunnerJobExecutionsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetRunnerJobExecutionsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetRunnerJobExecutionsRequestTypedDict(TypedDict):
    runner_job_id: str
    r"""runner job ID"""
...
class GetRunnerJobExecutionsRequest(BaseModel):
