...
class GetAppReleasesSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetAppReleasesSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetAppReleasesRequestTypedDict(TypedDict):
    app_id: str
    r"""app ID"""
...
class GetAppReleasesRequest(BaseModel):
    app_id: Annotated[
