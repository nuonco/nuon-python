...
class GetInstallComponentDeploysSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetInstallComponentDeploysSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetInstallComponentDeploysRequestTypedDict(TypedDict):
    install_id: str
    r"""install ID"""
    component_id: str
    r"""component ID"""
...
class GetInstallComponentDeploysRequest(BaseModel):
