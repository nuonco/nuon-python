...
class GetInstallActionWorkflowRecentRunsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetInstallActionWorkflowRecentRunsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetInstallActionWorkflowRecentRunsRequestTypedDict(TypedDict):
    install_id: str
    r"""install ID"""
...
class GetInstallActionWorkflowRecentRunsRequest(BaseModel):
