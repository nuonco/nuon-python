...
class GetInstallDeploysSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetInstallDeploysSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetInstallDeploysRequestTypedDict(TypedDict):
    install_id: str
    r"""install ID"""
...
class GetInstallDeploysRequest(BaseModel):
