...
class GetInstallActionWorkflowsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetInstallActionWorkflowsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetInstallActionWorkflowsRequestTypedDict(TypedDict):
    install_id: str
    r"""install ID"""
...
class GetInstallActionWorkflowsRequest(BaseModel):
