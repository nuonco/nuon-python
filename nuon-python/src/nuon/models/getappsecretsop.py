...
class GetAppSecretsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetAppSecretsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetAppSecretsRequestTypedDict(TypedDict):
    app_id: str
    r"""app ID"""
...
class GetAppSecretsRequest(BaseModel):
    app_id: Annotated[
