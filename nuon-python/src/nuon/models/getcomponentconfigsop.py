...
class GetComponentConfigsSecurityTypedDict(TypedDict):
    api_key: NotRequired[str]
    org_id: NotRequired[str]


class GetComponentConfigsSecurity(BaseModel):
    api_key: Annotated[
        Optional[str],
        FieldMetadata(
...
class GetComponentConfigsRequestTypedDict(TypedDict):
    component_id: str
    r"""component ID"""
...
class GetComponentConfigsRequest(BaseModel):
