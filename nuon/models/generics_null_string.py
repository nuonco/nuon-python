...
T = TypeVar("T", bound="GenericsNullString")


@_attrs_define
class GenericsNullString:
    """
    Attributes:
        string (str | Unset):
        valid (bool | Unset): Valid is true if String is not NULL
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        generics_null_string = cls(
            string=string,
            valid=valid,
        )

        generics_null_string.additional_properties = d
