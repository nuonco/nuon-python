...
class AppAppAWSIAMPolicyConfig(BaseModel):
    ...
    """ # noqa: E501
    app_aws_iam_role_config_id: Optional[StrictStr] = None
    ...
    managed_policy_name: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    org_id: Optional[StrictStr] = None
    updated_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["app_aws_iam_role_config_id", "app_config_id", "cloudformation_stack_name", "contents", "created_at", "created_by_id", "id", "managed_policy_name", "name", "org_id", "updated_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "app_aws_iam_role_config_id": obj.get("app_aws_iam_role_config_id"),
            ...
            "id": obj.get("id"),
            "managed_policy_name": obj.get("managed_policy_name"),
            "name": obj.get("name"),
