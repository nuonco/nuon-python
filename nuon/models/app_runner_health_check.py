...
class AppRunnerHealthCheck(BaseModel):
    ...
    minute_bucket: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["created_at", "created_by_id", "id", "minute_bucket", "runner_id", "runner_job", "status", "status_code", "updated_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "minute_bucket": obj.get("minute_bucket"),
