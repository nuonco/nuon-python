...
class AppActionWorkflowTriggerConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action_workflow_config_id", "app_config_id", "app_id", "component", "component_id", "created_at", "created_by_id", "cron_schedule", "id", "type", "updated_at"]
