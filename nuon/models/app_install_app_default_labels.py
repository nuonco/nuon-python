...
T = TypeVar("T", bound="AppInstallAppDefaultLabels")


@_attrs_define
class AppInstallAppDefaultLabels:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        app_install_app_default_labels = cls()

        app_install_app_default_labels.additional_properties = d
        return app_install_app_default_labels
