...
class StateInstallState(BaseModel):
    ...
    internal_domain: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    populated: Optional[StrictBool] = None
    public_domain: Optional[StrictStr] = None
    sandbox: Optional[StateSandboxState] = None
    __properties: ClassVar[List[str]] = ["id", "inputs", "internal_domain", "name", "populated", "public_domain", "sandbox"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "internal_domain": obj.get("internal_domain"),
            "name": obj.get("name"),
