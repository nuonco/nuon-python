...
class AppRunbook:
    ...
    Attributes:
        ...
        configs (list[AppRunbookConfig] | Unset):
    ...
    configs: list[AppRunbookConfig] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _configs is not UNSET:
            ...
            for configs_item_data in _configs:
                configs_item = AppRunbookConfig.from_dict(configs_item_data)
        ...
        app_runbook.additional_properties = d
        return app_runbook
