...
if TYPE_CHECKING:
    ...
    from ..models.service_create_install_config_request_labels import ServiceCreateInstallConfigRequestLabels


T = TypeVar("T", bound="ServiceCreateInstallConfigRequest")


@_attrs_define
class ServiceCreateInstallConfigRequest:
    """
    Attributes:
        approval_option (AppInstallApprovalOption | Unset):
        custom_nested_stacks (list[ConfigCustomNestedStack] | Unset):
        labels (ServiceCreateInstallConfigRequestLabels | Unset):
    ...
    labels: ServiceCreateInstallConfigRequestLabels | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_labels, Unset):
            ...
            labels = ServiceCreateInstallConfigRequestLabels.from_dict(_labels)
        ...
        service_create_install_config_request = cls(
        ...
        service_create_install_config_request.additional_properties = d
        return service_create_install_config_request
