...
class AppAppInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_input_id", "created_at", "created_by_id", "default", "description", "display_name", "group", "group_id", "id", "index", "internal", "name", "org_id", "required", "sensitive", "type", "updated_at"]
