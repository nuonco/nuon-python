...
class AppRunnerJobExecution(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "created_by_id", "id", "org_id", "outputs", "result", "runner_job_id", "status", "updated_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "outputs": AppRunnerJobExecutionOutputs.from_dict(obj.get("outputs")) if obj.get("outputs") is not None else None,
