...
class AppHelmComponentConfig(BaseModel):
    ...
    take_ownership: Optional[StrictBool] = Field(default=None, description="Newer config fields that we don't need a column for")
    updated_at: Optional[StrictStr] = None
    values: Optional[Dict[str, StrictStr]] = None
    values_files: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["chart_name", "component_config_connection_id", "connected_github_vcs_config", "created_at", "created_by_id", "helm_config_json", "id", "namespace", "public_git_vcs_config", "storage_driver", "take_ownership", "updated_at", "values", "values_files"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of helm_config_json
        if self.helm_config_json:
            _dict['helm_config_json'] = self.helm_config_json.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "helm_config_json": AppHelmConfig.from_dict(obj.get("helm_config_json")) if obj.get("helm_config_json") is not None else None,
            "id": obj.get("id"),
