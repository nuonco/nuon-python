...
class ServiceCreateInstallDeployRequest(BaseModel):
    ...
    deploy_dependents: Optional[StrictBool] = None
    plan_only: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["build_id", "deploy_dependents", "plan_only"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "deploy_dependents": obj.get("deploy_dependents"),
