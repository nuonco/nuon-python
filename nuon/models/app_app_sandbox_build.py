...
class AppAppSandboxBuild:
    ...
    vcs_connection_commit_id: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        vcs_connection_commit_id = self.vcs_connection_commit_id
        ...
        if vcs_connection_commit_id is not UNSET:
            field_dict["vcs_connection_commit_id"] = vcs_connection_commit_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        app_app_sandbox_build = cls(
            ...
            vcs_connection_commit_id=vcs_connection_commit_id,
        )

        app_app_sandbox_build.additional_properties = d
        return app_app_sandbox_build
