...
T = TypeVar("T", bound="ServiceUpdateInstallerRequestMetadata")


@_attrs_define
class ServiceUpdateInstallerRequestMetadata:
    """
    Attributes:
        community_url (str):
        description (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_update_installer_request_metadata = cls(
            community_url=community_url,
            description=description,
            documentation_url=documentation_url,
            favicon_url=favicon_url,
        ...
        service_update_installer_request_metadata.additional_properties = d
