...
class ServiceCreateActionWorkflowConfigRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_config_id", "dependencies", "references", "steps", "timeout", "triggers"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "steps": [ServiceCreateActionWorkflowConfigStepRequest.from_dict(_item) for _item in obj.get("steps")] if obj.get("steps") is not None else None,
            "timeout": obj.get("timeout"),
            "triggers": [ServiceCreateActionWorkflowConfigTriggerRequest.from_dict(_item) for _item in obj.get("triggers")] if obj.get("triggers") is not None else None
        })
        return _obj
