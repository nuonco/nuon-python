...
class ServiceCreateTerraformModuleComponentConfigRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_config_id", "checksum", "connected_github_vcs_config", "dependencies", "env_vars", "public_git_vcs_config", "references", "variables", "variables_files", "version"]
