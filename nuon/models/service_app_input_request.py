...
class ServiceAppInputRequest(BaseModel):
    ...
    group: StrictStr
    index: StrictInt
    internal: Optional[StrictBool] = Field(default=None, description="New, optional fields")
    required: Optional[StrictBool] = None
    sensitive: Optional[StrictBool] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["default", "description", "display_name", "group", "index", "internal", "required", "sensitive", "type"]
