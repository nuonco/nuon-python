...
class AppApp(BaseModel):
    ...
    config_directory: Optional[StrictStr] = None
    config_repo: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["cloud_platform", "config_directory", "config_repo", "created_at", "created_by_id", "description", "display_name", "id", "input_config", "links", "name", "notifications_config", "org_id", "runner_config", "runner_type", "sandbox_config", "status", "status_description", "updated_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "config_directory": obj.get("config_directory"),
            "config_repo": obj.get("config_repo"),
