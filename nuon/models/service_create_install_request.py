...
class ServiceCreateInstallRequest(BaseModel):
    ...
    name: StrictStr
    __properties: ClassVar[List[str]] = ["aws_account", "azure_account", "inputs", "install_config", "name"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "install_config": HelpersCreateInstallConfigParams.from_dict(obj.get("install_config")) if obj.get("install_config") is not None else None,
            "name": obj.get("name")
        })
        return _obj
