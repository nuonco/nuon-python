...
class AppOrgInvite(BaseModel):
    ...
    org_id: Optional[StrictStr] = Field(default=None, description="parent relationship")
    role_type: Optional[AppRoleType] = None
    status: Optional[AppOrgInviteStatus] = None
    updated_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["created_at", "created_by_id", "email", "id", "org_id", "role_type", "status", "updated_at"]
