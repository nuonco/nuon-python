...
class AppTerraformWorkspaceLock(BaseModel):
    ...
    workspace_id: Optional[StrictStr] = Field(default=None, description="Foreign key to TerraformWorkspace with unique constraint to prevent multiple active locks")
    __properties: ClassVar[List[str]] = ["created_at", "created_by_id", "id", "lock", "runner_job", "runner_job_id", "updated_at", "workspace_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "lock": AppTerraformLock.from_dict(obj.get("lock")) if obj.get("lock") is not None else None,
