...
class AppLogStream(BaseModel):
    ...
    AppLogStream
    """ # noqa: E501
    attrs: Optional[Dict[str, StrictStr]] = None
    ...
    write_token: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["attrs", "created_at", "created_by_id", "id", "open", "org_id", "owner_id", "owner_type", "runner_api_url", "updated_at", "write_token"]
