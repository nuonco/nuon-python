...
T = TypeVar("T", bound="ServiceReprovisionInstallSandboxRequest")


@_attrs_define
class ServiceReprovisionInstallSandboxRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return service_reprovision_install_sandbox_request
