...
class ServiceCreateAppSecretsConfigRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_config_id", "secrets"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "secrets": [ServiceAppSecretConfig.from_dict(_item) for _item in obj.get("secrets")] if obj.get("secrets") is not None else None
        })
        return _obj
