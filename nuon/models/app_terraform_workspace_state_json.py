...
class AppTerraformWorkspaceStateJSON(BaseModel):
    ...
    workspace_id: Optional[StrictStr] = Field(default=None, description="Foreign key to TerraformWorkspace with unique constraint to prevent conflicting states for a workspace")
    __properties: ClassVar[List[str]] = ["contents", "created_at", "created_by_id", "id", "runner_job", "runner_job_id", "updated_at", "workspace_id"]
