...
T = TypeVar("T", bound="AppGithubEvent")


@_attrs_define
class AppGithubEvent:
    """
    Attributes:
    ...
    id: str | Unset = UNSET
    payload: BlobstoreBlob | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_payload, Unset):
            ...
            payload = BlobstoreBlob.from_dict(_payload)
        ...
        app_github_event.additional_properties = d
        return app_github_event
