...
T = TypeVar("T", bound="AppNotificationsConfig")


@_attrs_define
class AppNotificationsConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        app_notifications_config.additional_properties = d
        return app_notifications_config
