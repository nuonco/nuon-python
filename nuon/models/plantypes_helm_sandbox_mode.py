...
T = TypeVar("T", bound="PlantypesHelmSandboxMode")


@_attrs_define
class PlantypesHelmSandboxMode:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        plantypes_helm_sandbox_mode = cls(
            plan_contents=plan_contents,
            plan_display_contents=plan_display_contents,
        )

        plantypes_helm_sandbox_mode.additional_properties = d
