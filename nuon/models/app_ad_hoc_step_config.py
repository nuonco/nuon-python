...
if TYPE_CHECKING:
    from ..models.app_ad_hoc_step_config_env_vars import AppAdHocStepConfigEnvVars
...
T = TypeVar("T", bound="AppAdHocStepConfig")


@_attrs_define
class AppAdHocStepConfig:
    """
    Attributes:
        ...
        env_vars (AppAdHocStepConfigEnvVars | Unset):
        id (str | Unset):
        idx (int | Unset):
    ...
    env_vars: AppAdHocStepConfigEnvVars | Unset = UNSET
    id: str | Unset = UNSET
    idx: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_env_vars, Unset):
            ...
            env_vars = AppAdHocStepConfigEnvVars.from_dict(_env_vars)
        ...
        app_ad_hoc_step_config.additional_properties = d
        return app_ad_hoc_step_config
