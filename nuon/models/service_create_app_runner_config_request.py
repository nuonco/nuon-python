...
class ServiceCreateAppRunnerConfigRequest(BaseModel):
    ...
    init_script_url: Optional[StrictStr] = None
    type: AppAppRunnerType
    __properties: ClassVar[List[str]] = ["app_config_id", "env_vars", "helm_driver", "init_script_url", "type"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "init_script_url": obj.get("init_script_url"),
            "type": obj.get("type")
        })
        return _obj
