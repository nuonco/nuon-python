...
if TYPE_CHECKING:
    from ..models.service_create_component_request_labels import ServiceCreateComponentRequestLabels
...
class ServiceCreateComponentRequest:
    ...
    Attributes:
        ...
        labels (ServiceCreateComponentRequestLabels | Unset):
        var_name (str | Unset):
    """

    name: str
    dependencies: list[str] | Unset = UNSET
    labels: ServiceCreateComponentRequestLabels | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_labels, Unset):
            ...
            labels = ServiceCreateComponentRequestLabels.from_dict(_labels)
