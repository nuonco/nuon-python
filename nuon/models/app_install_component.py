...
class AppInstallComponent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["component", "component_id", "created_at", "created_by_id", "helm_chart", "id", "install_deploys", "install_id", "links", "status", "status_description", "status_v2", "terraform_workspace", "updated_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.helm_chart:
            _dict['helm_chart'] = self.helm_chart.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "helm_chart": AppHelmChart.from_dict(obj.get("helm_chart")) if obj.get("helm_chart") is not None else None,
            "id": obj.get("id"),
