...
class ServiceAppAWSIAMRoleConfig(BaseModel):
    ...
    policies: Optional[Annotated[List[ServiceAppAWSIAMPolicyConfig], Field(min_length=1)]] = None
    __properties: ClassVar[List[str]] = ["description", "display_name", "name", "permissions_boundary", "policies"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "policies": [ServiceAppAWSIAMPolicyConfig.from_dict(_item) for _item in obj.get("policies")] if obj.get("policies") is not None else None
        })
        return _obj
