...
class ServiceCreateAppSandboxConfigRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connected_github_vcs_config": ServiceConnectedGithubVCSSandboxConfigRequest.from_dict(obj["connected_github_vcs_config"]) if obj.get("connected_github_vcs_config") is not None else None,
            "public_git_vcs_config": ServicePublicGitVCSSandboxConfigRequest.from_dict(obj["public_git_vcs_config"]) if obj.get("public_git_vcs_config") is not None else None,
