...
class AppOtelLogRecord(BaseModel):
    ...
    org_id: Optional[StrictStr] = Field(default=None, description="internal attributes")
    ...
    runner_job_execution_step: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["body", "created_at", "created_by_id", "id", "log_attributes", "log_stream_id", "org_id", "resource_attributes", "resource_schema_url", "runner_group_id", "runner_id", "runner_job_execution_id", "runner_job_execution_step", "runner_job_id", "scope_attributes", "scope_name", "scope_schema_url", "scope_version", "service_name", "severity_number", "severity_text", "span_id", "timestamp", "timestamp_date", "timestamp_time", "trace_flags", "trace_id", "updated_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "runner_job_execution_step": obj.get("runner_job_execution_step"),
