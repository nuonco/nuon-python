...
class AppRunnerHeartBeat(BaseModel):
    ...
    AppRunnerHeartBeat
    """ # noqa: E501
    alive_time: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["alive_time", "created_at", "created_by_id", "id", "runner_id", "started_at", "updated_at", "version"]
