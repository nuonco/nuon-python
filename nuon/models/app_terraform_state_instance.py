...
class AppTerraformStateInstance:
    """
    Attributes:
        attributes (Union[Unset, AppTerraformStateInstanceAttributes]):
        schema_version (Union[Unset, int]):
        sensitive_attributes (Union[Unset, list[Any]]):
    """

    attributes: Union[Unset, "AppTerraformStateInstanceAttributes"] = UNSET
    schema_version: Union[Unset, int] = UNSET
    sensitive_attributes: Union[Unset, list[Any]] = UNSET
