...
if TYPE_CHECKING:
    from ..models.service_update_cell_request_env_vars import ServiceUpdateCellRequestEnvVars


T = TypeVar("T", bound="ServiceUpdateCellRequest")


@_attrs_define
class ServiceUpdateCellRequest:
    """
    Attributes:
        command (str | Unset):
        enable_kube_config (bool | None | Unset):
        env_vars (ServiceUpdateCellRequestEnvVars | Unset):
    ...
    env_vars: ServiceUpdateCellRequestEnvVars | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_env_vars, Unset):
            ...
            env_vars = ServiceUpdateCellRequestEnvVars.from_dict(_env_vars)
        ...
        service_update_cell_request = cls(
            command=command,
        ...
        service_update_cell_request.additional_properties = d
        return service_update_cell_request
