...
class StateCloudAccount(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["aws", "azure"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "aws": StateAWSCloudAccount.from_dict(obj.get("aws")) if obj.get("aws") is not None else None,
            "azure": StateAzureCloudAccount.from_dict(obj.get("azure")) if obj.get("azure") is not None else None
        })
        return _obj
