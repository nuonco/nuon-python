...
@_attrs_define
class ServiceInstallPermissionsRoleStatus:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_install_permissions_role_status = cls(
        ...
        service_install_permissions_role_status.additional_properties = d
        return service_install_permissions_role_status
