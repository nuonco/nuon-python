...
class AppInstallAuditLog(BaseModel):
    ...
    log_line: Optional[StrictStr] = None
    time_stamp: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["install_id", "log_line", "time_stamp", "type"]
