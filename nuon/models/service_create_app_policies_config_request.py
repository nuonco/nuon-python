...
class ServiceCreateAppPoliciesConfigRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_config_id", "policies"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "policies": [ServiceAppPolicyConfig.from_dict(_item) for _item in obj.get("policies")] if obj.get("policies") is not None else None
        })
        return _obj
