...
T = TypeVar("T", bound="AppSlackChannelSubscriptionMatch")


@_attrs_define
class AppSlackChannelSubscriptionMatch:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        app_slack_channel_subscription_match = cls()

        app_slack_channel_subscription_match.additional_properties = d
        return app_slack_channel_subscription_match
