...
class ServiceUpdateRunnerSettingsRequest(BaseModel):
    ...
    """ # noqa: E501
    aws_max_instance_lifetime: Optional[Annotated[int, Field(le=31536000, strict=True, ge=86400)]] = None
    container_image_tag: Optional[StrictStr] = None
    container_image_url: Optional[StrictStr] = None
    org_awsiam_role_arn: Optional[StrictStr] = None
    org_k8s_service_account_name: Optional[StrictStr] = None
    runner_api_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["aws_max_instance_lifetime", "container_image_tag", "container_image_url", "org_awsiam_role_arn", "org_k8s_service_account_name", "runner_api_url"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "org_awsiam_role_arn": obj.get("org_awsiam_role_arn"),
