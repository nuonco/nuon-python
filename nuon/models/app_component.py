...
class AppComponent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_id", "config_versions", "created_at", "created_by_id", "dependencies", "id", "links", "name", "resolved_var_name", "status", "status_description", "type", "updated_at", "var_name"]
