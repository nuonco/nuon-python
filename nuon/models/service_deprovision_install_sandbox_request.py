...
T = TypeVar("T", bound="ServiceDeprovisionInstallSandboxRequest")
...
class ServiceDeprovisionInstallSandboxRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_deprovision_install_sandbox_request.additional_properties = d
        return service_deprovision_install_sandbox_request
