...
class ServiceCreateAppBreakGlassConfigRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_config_id", "roles"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "roles": [ServiceAppAWSIAMRoleConfig.from_dict(_item) for _item in obj.get("roles")] if obj.get("roles") is not None else None
        })
        return _obj
