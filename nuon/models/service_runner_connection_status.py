...
class ServiceRunnerConnectionStatus(BaseModel):
    ...
    latest_heartbeat_timestamp: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["connected", "latest_heartbeat_timestamp"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "latest_heartbeat_timestamp": obj.get("latest_heartbeat_timestamp")
        })
        return _obj
