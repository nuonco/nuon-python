...
T = TypeVar("T", bound="AppRunnerJobPermissionTraceRecord")


@_attrs_define
class AppRunnerJobPermissionTraceRecord:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        app_runner_job_permission_trace_record = cls(
            available=available,
            role_id=role_id,
            role_name=role_name,
        ...
        app_runner_job_permission_trace_record.additional_properties = d
        return app_runner_job_permission_trace_record
