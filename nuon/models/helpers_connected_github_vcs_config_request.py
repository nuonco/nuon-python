...
T = TypeVar("T", bound="HelpersConnectedGithubVCSConfigRequest")


@_attrs_define
class HelpersConnectedGithubVCSConfigRequest:
    """
    Attributes:
        directory (str):
        repo (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        helpers_connected_github_vcs_config_request = cls(
            directory=directory,
            repo=repo,
            branch=branch,
            git_ref=git_ref,
        ...
        helpers_connected_github_vcs_config_request.additional_properties = d
        return helpers_connected_github_vcs_config_request
