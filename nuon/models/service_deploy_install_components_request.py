...
T = TypeVar("T", bound="ServiceDeployInstallComponentsRequest")


@_attrs_define
class ServiceDeployInstallComponentsRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_deploy_install_components_request.additional_properties = d
