...
T = TypeVar("T", bound="AppAppKubernetesContextsConfig")


@_attrs_define
class AppAppKubernetesContextsConfig:
    """
    Attributes:
        app_config_id (str | Unset):
        app_id (str | Unset):
        contexts (list[AppAppKubernetesContextConfig] | Unset):
    ...
    contexts: list[AppAppKubernetesContextConfig] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _contexts is not UNSET:
            ...
            for contexts_item_data in _contexts:
                contexts_item = AppAppKubernetesContextConfig.from_dict(contexts_item_data)
        ...
        app_app_kubernetes_contexts_config = cls(
        ...
        app_app_kubernetes_contexts_config.additional_properties = d
        return app_app_kubernetes_contexts_config
