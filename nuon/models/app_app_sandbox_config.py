...
class AppAppSandboxConfig(BaseModel):
    ...
    aws_region_type: Optional[StrictStr] = Field(default=None, description="cloud specific fields")
    ...
    __properties: ClassVar[List[str]] = ["app_config_id", "app_id", "aws_region_type", "cloud_platform", "connected_github_vcs_config", "created_at", "created_by_id", "env_vars", "id", "org_id", "public_git_vcs_config", "terraform_version", "updated_at", "variables", "variables_files"]
