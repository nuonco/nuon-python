...
class ServiceCreateDockerBuildComponentConfigRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app_config_id", "build_args", "checksum", "connected_github_vcs_config", "dependencies", "dockerfile", "env_vars", "public_git_vcs_config", "references", "target"]
