...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/runner-jobs/{runner_job_id}/executions",
        "params": params,
    }
...
) -> Optional[Union[StderrErrResponse, list["AppRunnerJobExecution"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[StderrErrResponse, list["AppRunnerJobExecution"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[StderrErrResponse, list['AppRunnerJobExecution']]
    """
