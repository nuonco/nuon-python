...
) -> Optional[Union[StderrErrResponse, list["AppInstallEvent"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[StderrErrResponse, list["AppInstallEvent"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[StderrErrResponse, list['AppInstallEvent']]
    """
