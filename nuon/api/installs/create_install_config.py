...
from ...models.service_create_install_config_request import ServiceCreateInstallConfigRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/installs/{install_id}/configs".format(
...
def sync(
    ...
    *,
    ...
    Returns:
        AppInstallConfig | StderrErrResponse
    """
