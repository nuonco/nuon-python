...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/workflows/{workflow_id}/steps/{step_id}/await".format(
...
def sync_detailed(
    ...
    *,
    ...
    """long-poll for workflow step completion
     ...
     Long-poll for a workflow step to complete. Blocks until the step finishes or a 60-second timeout is
    reached.
