...
from ...models.service_remove_install_labels_request import ServiceRemoveInstallLabelsRequest
...
def _get_kwargs(
    install_id: str,
    *,
    body: ServiceRemoveInstallLabelsRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/v1/installs/{install_id}/labels".format(
