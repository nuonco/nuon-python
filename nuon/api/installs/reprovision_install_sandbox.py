...
from ...models.service_reprovision_install_sandbox_request import ServiceReprovisionInstallSandboxRequest
...
def _get_kwargs(
    install_id: str,
    *,
    body: ServiceReprovisionInstallSandboxRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/installs/{install_id}/reprovision-sandbox".format(
