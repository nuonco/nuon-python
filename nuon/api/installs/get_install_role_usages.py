...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/installs/{install_id}/roles/usages".format(
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = AppInstallRoleUsage.from_dict(response_200_item_data)
...
def sync(
    ...
    *,
    ...
    Returns:
        StderrErrResponse | list[AppInstallRoleUsage]
    """
