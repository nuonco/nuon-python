...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/installs/{install_id}/sandbox-runs",
        "params": params,
    }
...
) -> Optional[Union[StderrErrResponse, list["AppInstallSandboxRun"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = AppInstallSandboxRun.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[StderrErrResponse, list["AppInstallSandboxRun"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[StderrErrResponse, list['AppInstallSandboxRun']]
    """
