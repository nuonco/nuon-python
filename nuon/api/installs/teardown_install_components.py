...
from ...models.service_teardown_install_components_request import ServiceTeardownInstallComponentsRequest
...
def _get_kwargs(
    install_id: str,
    *,
    body: ServiceTeardownInstallComponentsRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/installs/{install_id}/components/teardown-all".format(
