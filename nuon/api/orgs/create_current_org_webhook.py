...
from ...models.service_create_current_org_webhook_request import ServiceCreateCurrentOrgWebhookRequest
...
def _get_kwargs(
    *,
    body: ServiceCreateCurrentOrgWebhookRequest,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ServiceCurrentOrgWebhookResponse.from_dict(response.json())
