...
) -> Optional[Union[StderrErrResponse, list["AppAppSecret"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = AppAppSecret.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[StderrErrResponse, list["AppAppSecret"]]]:
    return Response(
...
def sync(
    ...
    **NOTE** this does not return any sensitive values, as secrets are write only.
    ...
    Returns:
        Union[StderrErrResponse, list['AppAppSecret']]
    """
