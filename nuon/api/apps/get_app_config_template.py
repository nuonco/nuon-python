...
from ...models.get_app_config_template_type import GetAppConfigTemplateType
from ...models.service_app_config_template import ServiceAppConfigTemplate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/apps/{app_id}/template-config".format(
