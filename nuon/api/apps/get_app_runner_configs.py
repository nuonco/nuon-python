...
) -> Optional[Union[StderrErrResponse, list["AppAppRunnerConfig"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[StderrErrResponse, list["AppAppRunnerConfig"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[StderrErrResponse, list['AppAppRunnerConfig']]
    """
