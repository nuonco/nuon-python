...
from ...models.service_create_app_branch_config_request import ServiceCreateAppBranchConfigRequest
...
def _get_kwargs(
    ...
    app_branch_id: str,
    *,
    body: ServiceCreateAppBranchConfigRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/apps/{app_id}/branches/{app_branch_id}/configs".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = AppAppBranchConfig.from_dict(response.json())
