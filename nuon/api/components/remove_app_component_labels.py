...
from ...models.service_remove_component_labels_request import ServiceRemoveComponentLabelsRequest
...
def _get_kwargs(
    ...
    component_id: str,
    *,
    body: ServiceRemoveComponentLabelsRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/v1/apps/{app_id}/components/{component_id}/labels".format(
