...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/v1/components/{component_id}/configs/job",
    }
...
) -> Optional[Union[AppJobComponentConfig, StderrErrResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AppJobComponentConfig, StderrErrResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AppJobComponentConfig, StderrErrResponse]
    """
