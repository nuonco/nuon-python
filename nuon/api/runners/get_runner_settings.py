...
) -> Optional[Union[AppRunnerGroupSettings, StderrErrResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AppRunnerGroupSettings, StderrErrResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AppRunnerGroupSettings, StderrErrResponse]
    """
