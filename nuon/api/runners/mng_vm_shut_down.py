...
from ...models.service_mng_vm_shut_down_request import ServiceMngVMShutDownRequest
...
def _get_kwargs(
    runner_id: str,
    *,
    body: ServiceMngVMShutDownRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/runners/{runner_id}/mng/shutdown-vm".format(
