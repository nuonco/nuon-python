...
from ...models.app_runner_health_check import AppRunnerHealthCheck
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/runners/{runner_id}/recent-health-checks".format(
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = AppRunnerHealthCheck.from_dict(response_200_item_data)
