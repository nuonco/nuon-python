...
) -> Optional[Union[AppTerraformWorkspaceLock, StderrErrResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AppTerraformWorkspaceLock, StderrErrResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AppTerraformWorkspaceLock, StderrErrResponse]
    """
