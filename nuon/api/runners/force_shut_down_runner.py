...
from ...models.service_force_shutdown_request import ServiceForceShutdownRequest
...
def _get_kwargs(
    runner_id: str,
    *,
    body: ServiceForceShutdownRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/runners/{runner_id}/force-shutdown".format(
