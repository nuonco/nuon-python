...
def _get_kwargs(
    install_id: str,
    *,
    trigger_types: Union[Unset, str] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/installs/{install_id}/action-workflows/latest-runs",
        "params": params,
    }
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[StderrErrResponse, list['AppInstallActionWorkflow']]
    """
