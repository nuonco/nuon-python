...
from ...models.service_complete_your_stack_step_request import ServiceCompleteYourStackStepRequest
...
def _get_kwargs(
    *,
    body: ServiceCompleteYourStackStepRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/onboarding/current/steps/your-stack",
    }
