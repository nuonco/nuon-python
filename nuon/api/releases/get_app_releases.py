...
) -> Optional[Union[StderrErrResponse, list["AppComponentRelease"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[StderrErrResponse, list["AppComponentRelease"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[StderrErrResponse, list['AppComponentRelease']]
    """
