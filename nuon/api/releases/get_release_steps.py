...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/releases/{release_id}/steps",
        "params": params,
    }
...
) -> Optional[Union[StderrErrResponse, list["AppComponentReleaseStep"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = AppComponentReleaseStep.from_dict(response_200_item_data)
